...
import com.mandrain_mate.pojo.dto.UserRegisterFormDTO;
import com.mandrain_mate.service.impl.MailService;
...
public class userController {
    ...
    public Result userMail( @RequestParam String userMail ){
        ...
        //发送邮件
        Result result = mailService.sendTextMailMessage(userMail, Constants.Verification.TOPIC,VerificationCode);
        return result;
    }
    /**
     * 用户登录
